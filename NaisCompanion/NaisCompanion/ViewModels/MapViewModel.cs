    ...
    public class MapViewModel : TouristViewModel
    {
        private readonly List<TouristLocation> touristLocationsDataStore = new List<TouristLocation>
        {
            new TouristLocation { Id = 1,
                ...
                VisitedPayment = 30U, MinVisitDuration = 1U, PostPayment = 5U, PhotoPayment = 5U },
            new TouristLocation { Id = 2,
                ...
                Comments=new List<Comment>(),
                UploadedPhotos=new List<ImagePost>(),
                VisitedPayment = 15U, MinVisitDuration = 1U, PostPayment = 5U, PhotoPayment = 5U },
            ...
            new TouristLocation { Id = 4,
                ...
                Comments=new List<Comment>(),
                UploadedPhotos=new List<ImagePost>(),
                VisitedPayment = 50U, MinVisitDuration = 1U, PostPayment = 5U, PhotoPayment = 5U },
            new TouristLocation { Id = 5,
                ...
                Comments=new List<Comment>(),
                UploadedPhotos=new List<ImagePost>(),
                VisitedPayment = 2U, MinVisitDuration = 1U, PostPayment = 5U, PhotoPayment = 5U },
            new TouristLocation { Id = 6,
                ...
                Comments=new List<Comment>(),
                UploadedPhotos=new List<ImagePost>(),
                VisitedPayment = 40U, MinVisitDuration = 1U, PostPayment = 5U, PhotoPayment = 5U },
            ...
            new TouristLocation { Id = 8,
                ...
                Comments=new List<Comment>(),
                UploadedPhotos=new List<ImagePost>(),
                VisitedPayment = 5U, MinVisitDuration = 1U, PostPayment = 5U, PhotoPayment = 5U },
        ...
        private readonly List<RewardLocation> rewardLocationsDataStore = new List<RewardLocation>
        {
            ...
            new RewardLocation { Id = 9,
                ...
                Rewards = new List<Reward> {
                    new Reward { Id = 17, Name = "L Voucher", Description = "Gratis drink", Price = 40, ThumbnailUri = "https://i0.wp.com/www.bestglutenfreebeers.com/wp-content/uploads/2017/08/a.jpg?fit=800%2C800" },
                    new Reward { Id = 18, Name = "XL Voucher", Description = "Three gratis drinks", Price = 80, ThumbnailUri = "https://i1.wp.com/www.bestglutenfreebeers.com/wp-content/uploads/2017/08/DEZCUvYXoAIomhk.png?fit=1024%2C512" },
                    new Reward { Id = 19, Name = "XXL Voucher", Description = "Gratis beer and French fries", Price = 120, ThumbnailUri = "http://www.beerstyle.rs/images/06beerstyle/pivo_pomfrit_beerstyle_6.JPG" },
                }
            }
        };

        public string Title { get; private set; }
        public List<TouristLocation> TouristLocations => touristLocationsDataStore;
        public List<RewardLocation> RewardLocations => rewardLocationsDataStore;
        
        public MapViewModel(Tourist currentTourist)
            :base(currentTourist) { Title = "Tour of Niš"; }
    }
}